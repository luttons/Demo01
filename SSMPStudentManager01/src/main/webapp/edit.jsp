    ...
    <form action="/myweb/<%= request.getParameter("action") %>" method="post">
        ...
        <table border="0px" width="350px" height="300px">
            ...
            <tr>
                <td align="left" >性别：</td>
                <td>
                    男 <input type="radio" name="sex" value="1" <c:if test="${stu.sex == '1'}">checked</c:if>>|
                    女 <input type="radio" name="sex" value="0" <c:if test="${stu.sex == '0'}">checked</c:if>>|
                    未知 <input type="radio" name="sex" value="2" <c:if test="${stu.sex == '2'}">checked</c:if>>
                </td>
            </tr>
            <tr>
                <td align="left">年龄：</td>
